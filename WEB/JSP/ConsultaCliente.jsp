    ...
    <body>
        ...
        <main>
            <section id="principal">
                ...
                <p>Estado: <%= rs.getString("estado") %> </p>
                <p>Ciudad: <%= rs.getString("ciudad") %> </p>
                <p>Colonia: <%= rs.getString("colonia") %> </p>
                <p>Calle: <%= rs.getString("calle") %> </p>
                <p>Código postal: <%= rs.getInt("cp") %> </p>
            </section>
